...
void mm()
{
    ...
    settextstyle(4,0,3);
    setcolor(WHITE);
    outtextxy(450,340,"Press g select");
    outtextxy(450,370,"Press q to quit");
    outtextxy(450,400,"Press w and s for up and down buttons");
    settextstyle(3,0,4);
    setcolor(11);
}
void m2()
